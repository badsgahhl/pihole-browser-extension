<template>
  <b-card class="shadow" no-body>
    ...
    <b-card-body>
      <p>
        <b-button :href="LinkConfig.github_issue" class="text-light font-weight-bold"
                  size="small"
                  target="_blank">
      ...
      <b-button class="btn btn btn-sm btn-primary ml-3" type="success" @click="copy_to_clipboard">
